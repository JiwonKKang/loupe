/* Loupe UI kit — onboarding. One-time only: connect your Claude token.
   Loupe is a desktop app, so the token is saved once and reused across every
   project. Choosing a project folder + branches happens later, from the
   top-left project menu — not here. */
      ...
      <div style={{ width: 480, background: 'var(--surface-card)',
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginTop: 30 }}>
          ...
          <div style={{ marginLeft: 'auto' }}>
            <Button variant="primary" disabled={!tested} onClick={() => props.onFinish()}>Continue</Button>
          </div>
        </div>
      </div>
