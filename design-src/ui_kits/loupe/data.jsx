/* Loupe UI kit — fake review data + a tiny Go syntax highlighter.
   Exposes window.LoupeData = { cards, highlightGo }.
   Loaded as text/babel (uses React.createElement via JSX). */
...
(function () {
  ...
  window.LoupeData = { cards, highlightGo, tree: buildTree(cards) };
})();
